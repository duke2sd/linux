...
arch-chroot /mnt hwclock --systohc
arch-chroot /mnt pacman -Syyu --needed nomacs git curl wget zsh fwupd packagekit-qt5 ntfs-3g dosfstools xfsprogs xfsdump grub efibootmgr networkmanager net-tools xorg pacman-contrib variety plank ccache haveged ufw bluez hplip cups go os-prober libreoffice-fresh thunderbird openssh wpa_supplicant dhcpcd acpi cpio ffmpegthumbs xf86-video-intel xfce4-goodies file-roller network-manager-applet leafpad epdfview galculator lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings capitaine-cursors arc-gtk-theme xdg-user-dirs-gtk --noconfirm
